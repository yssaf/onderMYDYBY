...
class Movies extends Model
{
    ...
    protected $fillable = [
        'name', 'sort_name', 'search_name', 'imdb_id', 'released', 'purchased', 'image', 'rating',
        'running_time', 'certificate_id', 'format_id', 'studio_id','bio', 'duplicate','user_id'
        ];
    ...
    {
        return $this->belongsToMany('App\Persons', 'casts', 'movie_id', 'person_id')
    ...
    {
        return $this->belongsToMany('App\Persons', 'crews', 'movie_id', 'person_id')
    ...
    {
        return $this->hasMany('App\Viewing', 'movie_id');
    }
