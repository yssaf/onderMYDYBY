...
@section('subnav-left')
    ...
    @include('layouts.links.view_movie')
    @include('layouts.links.add_movie')
    @include('layouts.links.edit_next_movie')
@stop
...
@section('content')
    ...
    <div class="row movie">
        ...
        <div id="left-hand-column" class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <img class="img-responsive img-rounded" src="{{asset('images/no-ondermdb.jpg')}}" alt="{{$movie->name}}" />
                    @else
            ...
            <div class="side-buttons">
                <hr/>
                @include('layouts.buttons.view_movie')
        ...
        <div class="col-xs-12 col-sm-offset-3 col-sm-9 col-md-offset-3 col-md-9 col-lg-offset-1 col-lg-8">
            ...
            {{--{!! Form::model($movie, ['method'=>'PATCH','action'=>['MovieController@update', $movie->movie_id],'files' => true]) !!}--}}
