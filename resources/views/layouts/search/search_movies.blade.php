...
<div class="input-group">
    <input class="form-control" value="" id="filter-movie" name="filter-movie-text" type="text" autocomplete="off" placeholder="Search ..." />
    ...
    <span class="input-group-btn">
         ...
         <ul class="dropdown-menu dropdown-menu-right">
            ...
            {{--<li><a href="" onClick="document.location.reload(true)">Clear</a></li>--}}
         </ul>
      </span>
</div>
{!! Form::close() !!}
