...
class NewRelicHandlerTest extends TestCase
{
    ...
    {
        $handler = new StubNewRelicHandler();
        $handler->handle($this->getRecord(Logger::ERROR, 'log messages', array('a' => 'b')));
    ...
    {
        $record = $this->getRecord(Logger::ERROR, 'log messages');
    ...
    {
        $record = $this->getRecord(Logger::ERROR, 'log messages', array('a' => 'b'));
        $record['extra'] = array('c' => 'd');
    ...
    {
        $handler = new StubNewRelicHandler();
        $handler->handle($this->getRecord(Logger::ERROR, 'log messages'));
    ...
    {
        $handler = new StubNewRelicHandler(Logger::DEBUG, false, 'myAppName');
        $handler->handle($this->getRecord(Logger::ERROR, 'log messages', array('appname' => 'logAppName')));
    ...
    {
        $handler = new StubNewRelicHandler(Logger::DEBUG, false, null, false, 'myTransaction');
        $handler->handle($this->getRecord(Logger::ERROR, 'log messages', array('transaction_name' => 'logTransactName')));
