...
class ErrorLogHandlerTest extends TestCase
{
     ...
     * @expectedExceptionMessage The given messages type "42" is not supported
     */
    ...
    public function testShouldLogMessagesUsingErrorLogFuncion()
    {
        ...
        $handler->setFormatter(new LineFormatter('%channel%.%level_name%: %messages% %context% %extra%', null, true));
