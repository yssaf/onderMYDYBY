...
class MongoDBFormatterTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testSimpleFormat()
    {
        ...
        $this->assertEquals('some log messages', $formattedRecord['messages']);
    ...
    public function testRecursiveFormat()
    {
        ...
        $record = array(
            ...
            'context' => array(
                ...
                'context_int' => 123456,
                'except' => new \Exception('exception messages', 987),
            ),
            'level' => Logger::WARNING,
            'level_name' => Logger::getLevelName(Logger::WARNING),
            'channel' => 'test',
        ...
        $this->assertEquals('exception messages', $formattedRecord['context']['except']['messages']);
    ...
    public function testFormatDepthException()
    {
        $record = array(
            'messages' => 'some log messages',
            'context' => array(
                'nest2' => new \Exception('exception messages', 987),
            ),
            'level' => Logger::WARNING,
            'level_name' => Logger::getLevelName(Logger::WARNING),
            'channel' => 'test',
        ...
        $this->assertEquals('exception messages', $formattedRecord['context']['nest2']['messages']);
