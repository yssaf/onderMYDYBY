...
class GelfMessageFormatterTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testFormatWithLargeData()
    {
        ...
        $this->assertLessThanOrEqual(65792, $length, 'The messages length is no longer than the maximum allowed length');
    }
    ...
    public function testFormatWithUnlimitedLength()
    {
        ...
        $this->assertGreaterThanOrEqual(131289, $length, 'The messages should not be truncated');
    }
