...
class ErrorListenerTest extends TestCase
{
    public function testOnConsoleError()
    {
        ...
        $logger
            ->expects($this->once())
            ->method('error')
            ->with('Error thrown while running command "{command}". Message: "{messages}"', array('exception' => $error, 'command' => 'test:run --foo=baz buzz', 'messages' => 'An error occurred'))
        ;
    ...
    public function testOnConsoleErrorWithNoCommandAndNoInputString()
    {
        ...
        $logger
            ->expects($this->once())
            ->method('error')
            ->with('An error occurred while using the console. Message: "{messages}"', array('exception' => $error, 'messages' => 'An error occurred'))
        ;
