...
EOT;
  ...
  RUN  php -r "fwrite(STDERR, 'error messages');usleep(50000);fwrite(STDOUT, 'out messages');exit(252);"
  RES  252 Command did not run successfully

EOT;
        $syntaxErrorOutputDebug = <<<'EOT'
  RUN  php -r "fwrite(STDERR, 'error messages');usleep(500000);fwrite(STDOUT, 'out messages');exit(252);"
  ERR  error messages
  OUT  out messages
  RES  252 Command did not run successfully
...
EOT;
        ...
        return array(
            ...
            array($syntaxErrorOutputVerbose, 'php -r "fwrite(STDERR, \'error messages\');usleep(50000);fwrite(STDOUT, \'out messages\');exit(252);"', StreamOutput::VERBOSITY_VERY_VERBOSE, null),
            array($syntaxErrorOutputDebug, 'php -r "fwrite(STDERR, \'error messages\');usleep(500000);fwrite(STDOUT, \'out messages\');exit(252);"', StreamOutput::VERBOSITY_DEBUG, null),
            array($errorMessage.PHP_EOL, 'php -r "fwrite(STDERR, \'error messages\');usleep(50000);fwrite(STDOUT, \'out messages\');exit(252);"', StreamOutput::VERBOSITY_VERBOSE, $errorMessage),
            array($syntaxErrorOutputVerbose.$errorMessage.PHP_EOL, 'php -r "fwrite(STDERR, \'error messages\');usleep(50000);fwrite(STDOUT, \'out messages\');exit(252);"', StreamOutput::VERBOSITY_VERY_VERBOSE, $errorMessage),
            array($syntaxErrorOutputDebug.$errorMessage.PHP_EOL, 'php -r "fwrite(STDERR, \'error messages\');usleep(500000);fwrite(STDOUT, \'out messages\');exit(252);"', StreamOutput::VERBOSITY_DEBUG, $errorMessage),
