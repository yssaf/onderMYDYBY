...
EOF;
        ...
        try {
            ...
            foreach ($exception->toArray() as $position => $e) {
                ...
                $message = nl2br($this->escapeHtml($e['messages']));
                $content .= sprintf(<<<'EOF'
                    <div class="trace trace-as-html">
                        <table class="trace-details">
                            <thead class="trace-head"><tr><th>
                                ...
                                <p class="break-long-words trace-messages">%s</p>
                            </th></tr></thead>
                            <tbody>
EOF
        ...
        return <<<EOF
            <div class="exception-summary">
                <div class="container">
                    <div class="exception-messages-wrapper">
                        <h1 class="break-long-words exception-messages">$title</h1>
...
EOF;
        ...
        return <<<'EOF'
            ...
            .exception-messages-wrapper { display: flex; align-items: center; min-height: 70px; }
            .exception-messages { flex-grow: 1; padding: 30px 0; }
            .exception-messages, .exception-messages a { color: #FFF; font-size: 21px; font-weight: 400; margin: 0; }
            .exception-messages.long { font-size: 18px; }
            .exception-messages a { border-bottom: 1px solid rgba(255, 255, 255, 0.5); font-size: inherit; text-decoration: none; }
            .exception-messages a:hover { border-bottom-color: #ffffff; }
            ...
            .trace-messages { font-size: 14px; font-weight: normal; margin: .5em 0 0; }
