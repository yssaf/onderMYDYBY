...
class DebugClassLoaderTest extends TestCase
{
    ...
    public function testDeprecatedSuper($class, $super, $type)
    {
        ...
        $xError = array(
            ...
            'messages' => 'The "Test\Symfony\Component\Debug\Tests\\'.$class.'" class '.$type.' "Symfony\Component\Debug\Tests\Fixtures\\'.$super.'" that is deprecated but this is a test deprecation notice.',
        );
    ...
    public function testExtendedFinalClass()
    {
        ...
        $xError = array(
            'type' => E_USER_DEPRECATED,
            'messages' => 'The "Symfony\Component\Debug\Tests\Fixtures\FinalClass" class is considered final. It may change without further notice as of its next major version. You should not extend it from "Test\Symfony\Component\Debug\Tests\ExtendsFinalClass".',
        );
    ...
    public function testExtendedFinalMethod()
    {
        ...
        $xError = array(
            'type' => E_USER_DEPRECATED,
            'messages' => 'The "Symfony\Component\Debug\Tests\Fixtures\FinalMethod::finalMethod()" method is considered final. It may change without further notice as of its next major version. You should not extend it from "Symfony\Component\Debug\Tests\Fixtures\ExtendedFinalMethod".',
        );
    ...
    public function testExtendedDeprecatedMethodDoesntTriggerAnyNotice()
    {
        ...
        $this->assertSame(array('type' => E_USER_NOTICE, 'messages' => ''), $lastError);
    }
