...
class FlattenExceptionTest extends TestCase
{
    ...
    public function testFlattenHttpException(\Throwable $exception)
    {
        ...
        $this->assertEquals($exception->getMessage(), $flattened->getMessage(), 'The messages is copied from the original exception.');
    ...
    public function testWrappedThrowable()
    {
        ...
        $this->assertSame('Ouch', $flattened->getMessage(), 'The messages is copied from the original error.');
    ...
    public function testPreviousError()
    {
        ...
        $this->assertEquals($flattened->getMessage(), 'Oh noes!', 'The messages is copied from the original exception.');
