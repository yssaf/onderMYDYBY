...
class AutoExpireFlashBagTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->array = array('new' => array('notice' => array('A previous flash messages')));
    ...
    {
        $bag = new FlashBag();
        $array = array('new' => array('notice' => array('A previous flash messages')));
        $bag->initialize($array);
        $this->assertEquals(array('A previous flash messages'), $bag->peek('notice'));
    ...
    public function testPeek()
    {
        ...
        $this->assertEquals(array('A previous flash messages'), $this->bag->peek('notice'));
        $this->assertEquals(array('A previous flash messages'), $this->bag->peek('notice'));
    }
    ...
    public function testGet()
    {
        ...
        $this->assertEquals(array('A previous flash messages'), $this->bag->get('notice'));
    ...
    public function testAll()
    {
        ...
        $this->assertEquals(array(
            'notice' => array('A previous flash messages'),
            ), $this->bag->all()
        );
    ...
    {
        $this->assertEquals(array('notice' => array('A previous flash messages')), $this->bag->clear());
    }
