...
class NativeSessionStorage implements SessionStorageInterface
{
    ...
    public function save()
    {
        ...
        if (null !== $e) {
            // The default PHP error messages is not very helpful, as it does not give any information on the current save handler.
            // Therefore, we catch this error and trigger a warning with a better error messages
