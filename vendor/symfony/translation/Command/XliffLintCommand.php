    ...
    private function validate($content, $file = null)
    {
        ...
        if (null !== $targetLanguage = $this->getTargetLanguageFromFile($document)) {
            ...
            if ($expectedFileExtension !== $realFileExtension) {
                $errors[] = array(
                    'line' => -1,
                    'column' => -1,
                    'messages' => sprintf('There is a mismatch between the file extension ("%s") and the "%s" value used in the "target-language" attribute of the file.', $realFileExtension, $targetLanguage),
                );
            }
        }
        ...
        foreach (libxml_get_errors() as $xmlError) {
            $errors[] = array(
                ...
                'messages' => trim($xmlError->message),
            );
        }
