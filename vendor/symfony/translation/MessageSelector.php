...
class MessageSelector
{
     ...
     *
     * @param string $message The messages being translated
     * @param int    $number  The number of items represented for the messages
    ...
    public function choose($message, $number, $locale)
    {
        ...
        foreach ($parts as $part) {
            ...
            if (preg_match('/^(?P<interval>'.Interval::getIntervalRegexp().')\s*(?P<messages>.*?)$/xs', $part, $matches)) {
                $explicitRules[$matches['interval']] = $matches['messages'];
