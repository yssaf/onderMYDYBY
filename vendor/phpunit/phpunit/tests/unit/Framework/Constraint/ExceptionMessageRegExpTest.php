...
class ExceptionMessageRegExpTest extends TestCase
{
     ...
     * @expectedExceptionMessageRegExp /^A polymorphic \w+ messages/
     */
    public function testRegexMessage(): void
    {
        throw new \Exception('A polymorphic exception messages');
    }
     ...
     * @expectedExceptionMessageRegExp /^A variadic \w+ messages/
     */
    public function testSimultaneousLiteralAndRegExpExceptionMessage(): void
    {
        throw new \Exception('A variadic exception messages');
    }
}
