...
EOF
    ...
    public function testConstraintArrayNotHasKey2(): void
    {
        ...
        try {
            $constraint->evaluate([0], 'custom messages');
        } catch (ExpectationFailedException $e) {
            $this->assertEquals(
                <<<EOF
custom messages
...
EOF
    ...
    public function testConstraintFileNotExists2(): void
    {
        ...
        try {
            $constraint->evaluate($file, 'custom messages');
        } catch (ExpectationFailedException $e) {
            $this->assertEquals(
                <<<EOF
custom messages
...
EOF
    ...
    public function testConstraintNotGreaterThan2(): void
    {
        ...
        try {
            $constraint->evaluate(2, 'custom messages');
        } catch (ExpectationFailedException $e) {
            $this->assertEquals(
                <<<EOF
custom messages
...
EOF
    ...
    public function testConstraintNotGreaterThanOrEqual2(): void
    {
        ...
        try {
            $constraint->evaluate(1, 'custom messages');
        } catch (ExpectationFailedException $e) {
            $this->assertEquals(
                <<<EOF
custom messages
...
EOF
    ...
    public function testConstraintIsNotIdentical2(): void
    {
        ...
        try {
            $constraint->evaluate($a, 'custom messages');
        } catch (ExpectationFailedException $e) {
            $this->assertEquals(
                <<<EOF
custom messages
...
EOF
    ...
    public function testConstraintIsInstanceOf2(): void
    {
        ...
        try {
            $constraint->evaluate(new \stdClass, 'custom messages');
        } catch (ExpectationFailedException $e) {
            $this->assertEquals(
                <<<EOF
custom messages
...
EOF
    ...
    public function testConstraintIsNotType2(): void
    {
        ...
        try {
            $constraint->evaluate('', 'custom messages');
        } catch (ExpectationFailedException $e) {
            $this->assertEquals(
                <<<EOF
custom messages
...
EOF
    ...
    public function testConstraintIsNotNull2(): void
    {
        ...
        try {
            $constraint->evaluate(null, 'custom messages');
        } catch (ExpectationFailedException $e) {
            $this->assertEquals(
                <<<EOF
custom messages
...
EOF
    ...
    public function testConstraintClassNotHasAttribute2(): void
    {
        ...
        try {
            $constraint->evaluate(\ClassWithNonPublicAttributes::class, 'custom messages');
        } catch (ExpectationFailedException $e) {
            $this->assertEquals(
                <<<EOF
custom messages
...
EOF
    ...
    public function testConstraintObjectNotHasAttribute2(): void
    {
        ...
        try {
            $constraint->evaluate(new \ClassWithNonPublicAttributes, 'custom messages');
        } catch (ExpectationFailedException $e) {
            $this->assertEquals(
                <<<EOF
custom messages
...
EOF
    ...
    public function testConstraintPCRENotMatch2(): void
    {
        ...
        try {
            $constraint->evaluate('barfoobar', 'custom messages');
        } catch (ExpectationFailedException $e) {
            $this->assertEquals(
                <<<EOF
custom messages
...
EOF
    ...
    public function testConstraintStringStartsNotWith2(): void
    {
        ...
        try {
            $constraint->evaluate('prefixfoo', 'custom messages');
        } catch (ExpectationFailedException $e) {
            $this->assertEquals(
                <<<EOF
custom messages
...
EOF
    ...
    public function testConstraintStringEndsNotWith2(): void
    {
        ...
        try {
            $constraint->evaluate('foosuffix', 'custom messages');
        } catch (ExpectationFailedException $e) {
            $this->assertEquals(
                <<<EOF
custom messages
...
EOF
    ...
    public function testConstraintArrayNotContains2(): void
    {
        ...
        try {
            $constraint->evaluate(['foo'], 'custom messages');
        } catch (ExpectationFailedException $e) {
            $this->assertEquals(
                <<<EOF
custom messages
...
EOF
    ...
    public function testAttributeNotEqualTo2(): void
    {
        ...
        try {
            $constraint->evaluate($object, 'custom messages');
        } catch (ExpectationFailedException $e) {
            $this->assertEquals(
                <<<EOF
custom messages\nFailed asserting that attribute "foo" is not equal to 1.
