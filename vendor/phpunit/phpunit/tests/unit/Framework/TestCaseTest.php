...
class TestCaseTest extends TestCase
{
    ...
    public function testExceptionWithWrongMessage(): void
    {
        ...
        $this->assertCount(1, $result);
        $this->assertEquals(
            "Failed asserting that exception messages 'A runtime error occurred' contains 'A logic error occurred'.",
    ...
    public function testExceptionWithWrongRegexpMessage(): void
    {
        ...
        $this->assertCount(1, $result);
        $this->assertEquals(
            "Failed asserting that exception messages 'A runtime error occurred' matches '/logic .*? occurred/'.",
            $test->getStatusMessage()
        );
    }
    ...
    public function testExceptionWithInvalidRegexpMessage(): void
    {
        ...
        $this->assertEquals(
            "Invalid expected exception messages regex given: '#runtime .*? occurred/'",
            $test->getStatusMessage()
        );
    }
