...
abstract class Swift_Transport_AbstractSmtpTest extends \SwiftMailerTestCase
{
    ...
    public function testStartSendsHeloToInitiate()
    {
        /* -- RFC 2821, 3.2.
         ...
         Once the server has sent the welcoming messages and the client has
    ...
    public function testSuccessfulRcptCommandWith250Response()
    {
     ...
     This step of the procedure can be repeated any number of times.
        ...
        -- RFC 2821, 4.2.2.
         ...
         (See section 3.4)
            252 Cannot VRFY user, but will accept messages and attempt
                    delivery
    ...
    public function testSuccessfulDataCommand()
    {
        ...
        mail data indicator to be the messages text.
    ...
    public function testBccRecipientsAreRemovedFromHeaders()
    {
     ...
     Addresses that do not appear in the messages headers may appear in the
     ...
     find it helpful to send each blind copy as a separate messages
