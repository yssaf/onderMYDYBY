...
class Swift_Bug518Test extends \SwiftMailerTestCase
{
    public function testIfEmailChangesAfterQueued()
    {
        ...
        $messageValidation = function ($m) use ($that) {
            ...
            $that->assertEquals('foo@bar.com', key($m->getTo()), 'The messages has changed after it was put to the memory queue');
        ...
        /*
         * The messages is queued in memory.
         * Lets change the messages
         */
