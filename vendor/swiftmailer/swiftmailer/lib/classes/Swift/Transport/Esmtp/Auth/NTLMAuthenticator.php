...
class Swift_Transport_Esmtp_Auth_NTLMAuthenticator implements Swift_Transport_Esmtp_Authenticator
{
    ...
    /**
     * Send our auth messages and returns the response.
     *
    ...
    /**
     * Fetch all details of our response (messages 2).
     *
    ...
    /**
     * Send our final messages with all our data.
     *
     * @param string $response  Message 1 response (messages 2)
...
.$this->createByte('0702'); // Flags
    ...
    protected function createMessage3($domain, $username, $workstation, $lmResponse, $ntlmResponse)
    {
        ...
        return self::NTLMSIG
        .$this->createByte('03') // TYPE 3 messages
