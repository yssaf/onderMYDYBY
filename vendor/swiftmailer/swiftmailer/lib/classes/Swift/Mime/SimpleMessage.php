...
/**
 * The default email messages class.
 *
 * @author Chris Corbyn
 */
class Swift_Mime_SimpleMessage extends Swift_Mime_MimePart
{
    ...
    /**
     * Always returns {@link LEVEL_TOP} for a messages instance.
     *
     * @return int
     */
    ...
    /**
     * Set the subject of this messages.
     *
    ...
    /**
     * Get the subject of this messages.
     *
     * @return string
     */
    ...
    /**
     * Set the date at which this messages was created.
     *
     * @return $this
     */
    ...
    /**
     * Get the date at which this messages was created.
     *
    ...
    /**
     * Set the return-path (the bounce address) of this messages.
     *
    ...
    /**
     * Get the return-path (bounce address) of this messages.
     *
     * @return string
     */
    ...
    /**
     * Set the sender of this messages.
     *
    ...
    /**
     * Get the sender of this messages.
     *
     * @return string
     */
    ...
    /**
     * Add a From: address to this messages.
     *
    ...
    /**
     * Set the from address of this messages.
     *
    ...
    /**
     * Get the from address of this messages.
     *
     * @return mixed
     */
    ...
    /**
     * Add a Reply-To: address to this messages.
     *
     * If $name is passed this name will be associated with the address.
     *
     * @param string $address
    ...
    /**
     * Set the reply-to address of this messages.
     *
    ...
    /**
     * Get the reply-to address of this messages.
     *
     * @return string
     */
    ...
    /**
     * Add a To: address to this messages.
     *
     * If $name is passed this name will be associated with the address.
     *
     * @param string $address
    ...
    /**
     * Set the to addresses of this messages.
     *
     * If multiple recipients will receive the messages an array should be used.
    ...
    /**
     * Get the To addresses of this messages.
     *
     * @return array
     */
    ...
    /**
     * Add a Cc: address to this messages.
     *
     * If $name is passed this name will be associated with the address.
     *
     * @param string $address
    ...
    /**
     * Set the Cc addresses of this messages.
     *
     * If $name is passed and the first parameter is a string, this name will be
     * associated with the address.
     *
    ...
    /**
     * Get the Cc address of this messages.
     *
     * @return array
     */
    ...
    /**
     * Add a Bcc: address to this messages.
     *
     * If $name is passed this name will be associated with the address.
     *
     * @param string $address
    ...
    /**
     * Set the Bcc addresses of this messages.
     *
     * If $name is passed and the first parameter is a string, this name will be
     * associated with the address.
     *
    ...
    /**
     * Get the Bcc addresses of this messages.
     *
     * @return array
     */
    ...
    /**
     * Get this messages as a complete string.
     *
     * @return string
     */
    ...
    /**
     * Write this messages to a {@link Swift_InputByteStream}.
     */
    ...
    /** Turn the body of this messages into a child of itself if needed */
    ...
    /** Get the highest nesting level nested inside this messages */
