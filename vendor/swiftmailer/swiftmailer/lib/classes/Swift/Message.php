...
class Swift_Message extends Swift_Mime_SimpleMessage
{
    ...
    public function __construct($subject = null, $body = null, $contentType = null, $charset = null)
    {
        call_user_func_array(
            ...
            Swift_DependencyContainer::getInstance()
                ->createDependenciesFor('mime.messages')
            );
    ...
    /**
     * Attach a new signature handler to the messages.
     *
     * @return $this
     */
    ...
    /**
     * Detach a signature handler from a messages.
     *
     * @return $this
     */
    ...
    /**
     * Clear all signature handlers attached to the messages.
     *
     * @return $this
     */
    ...
    {
        Swift_DependencyContainer::getInstance()->createDependenciesFor('mime.messages');
    }
    ...
    /**
     * save the messages before any signature is applied.
     */
